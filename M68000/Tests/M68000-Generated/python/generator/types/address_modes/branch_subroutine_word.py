"""
This module defines the branch subroutine word address mode
"""
import dataclasses
...
from .util.checks import check_is_even, check_register_value, check_displacement_word
...
class BranchSubroutineWord(DefaultAddressModeBase):
    """The class for branch subroutine."""
    value: int
    displacement: int
    ...
    def produce_outputs(self,
        ...
        return RegistersAndMemory(
            ...
            memory=self._create_memory(LONG_ADAPTER, program_counter + 4))
