...
def create_given_memory(address):
    return create_memory_words(address, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF)
...
__MOVEM_ADDRESS_DISPLACEMENT = TestData(
    ...
    when=['MOVEM.W D1-D2/A4-A5, (0xDC, A4)'],
    then=ThenConditions(
        status_register=StatusRegister(),
        pc=0x1006,
        cycles=28,
...
__MOVEM_ADDRESS_INDEX = TestData(
    ...
    when=['MOVEM.W D1-D2/A4-A5, (0x02, A4, A6.L)'],
    then=ThenConditions(
        status_register=StatusRegister(),
        pc=0x1006,
        cycles=30,
...
__MOVEM_ADDRESS_SHORT = TestData(
    ...
    when=['MOVEM.W D1-D2/A4-A5, (0xDCDC).W'],
    then=ThenConditions(
        status_register=StatusRegister(),
        pc=0x1006,
        cycles=28,
...
__MOVEM_ADDRESS_LONG = TestData(
    ...
    when=['MOVEM.W D1-D2/A4-A5, (0xBBCCBBCC).L'],
    then=ThenConditions(
        status_register=StatusRegister(),
        pc=0x1008,
        cycles=32,
...
MOVEM_WORD_MEMORY = ManualTestFile(
    name='movem_word_memory',
    d=[
